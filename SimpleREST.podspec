#
# Be sure to run `pod lib lint SimpleREST.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = 'Simple REST client with ability to cache response data'

  s.homepage         = 'https://github.com/alexander-gaidukov/SimpleREST'
